...
import { Loader2, Clock, Users, ChefHat, Globe, Pencil, Trash2 } from 'lucide-react';
  ...
  if (!recipe) {
    return (
      <div className="flex h-[70vh] flex-col items-center justify-center">
        <h1 className="mb-6 text-3xl font-bold text-gray-900">Recipe not found</h1>
        <button
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="container mx-auto max-w-4xl px-4">
        ...
        <div className="space-y-12">
          ...
          <div className="grid grid-cols-2 gap-6 sm:grid-cols-4">
            <div className="flex items-start gap-3 rounded-xl bg-white p-6 shadow-sm">
              ...
              <div>
                ...
                <p className="text-lg font-semibold text-gray-900">{recipe.cookingTime} mins</p>
              </div>
            </div>
            <div className="flex items-start gap-3 rounded-xl bg-white p-6 shadow-sm">
            ...
            <div className="flex items-start gap-3 rounded-xl bg-white p-6 shadow-sm">
              ...
              <div>
                ...
                <p className="text-lg font-semibold capitalize text-gray-900">{recipe.difficulty}</p>
              </div>
            </div>
            <div className="flex items-start gap-3 rounded-xl bg-white p-6 shadow-sm">
              ...
              <div>
                ...
                <p className="text-lg font-semibold text-gray-900">{recipe.cuisine}</p>
              </div>
            </div>
          </div>

          <div className="rounded-xl bg-white p-8 shadow-sm">
            <h2 className="mb-6 text-2xl font-bold text-gray-900">Ingredients</h2>
          ...
          <div className="rounded-xl bg-white p-8 shadow-sm">
            <h2 className="mb-6 text-2xl font-bold text-gray-900">Instructions</h2>
            <ol className="space-y-6">
              {recipe.instructions.map((instruction, index) => (
                <li key={index} className="flex gap-4">
                  ...
                  <p className="text-lg leading-relaxed text-gray-700">{instruction}</p>
                </li>
              ))}
            </ol>
          </div>
          ...
          <div className="rounded-xl bg-white p-6 shadow-sm">
            <div className="space-y-2 text-sm text-gray-500">
              <p className="font-medium">Created by <span className="text-gray-900">{recipe.author}</span></p>
              <p>Posted on {new Date(recipe.createdAt).toLocaleDateString('en-US', {
                year: 'numeric',
                month: 'long',
                day: 'numeric'
              })}</p>
